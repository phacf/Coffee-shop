...
export function Brand() {
  return (
    <div className="bg-[url('/public/images/hero-bg.svg')] bg-cover flex justify-center gap-14 px-40 py-20">
      <div className="w-5/12 ">
        <h1 className=" ">Encontre o café perfeito para qualquer hora do dia</h1>
